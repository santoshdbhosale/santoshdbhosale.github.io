...
As an associate scientific manager at Innoplexus Consulting Pvt. Ltd., Pune, India, I worked on data curation part for the outputs generated via different modules built to accelerate the drug discovery and development process using AI/ML approach. Specifically, I collaborated with product managers, data engineers and data scientist in an agile environment. Besides, data curation, I was also responsible for providing insights on enhancing the performance of LLMs model by optimizing the prompts and evaluating its accuracy. 
