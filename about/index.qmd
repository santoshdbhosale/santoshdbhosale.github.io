...
As an associate scientific manager at Innoplexus Consulting Pvt. Ltd., Pune, India, I worked on data curation part for the outputs generated via different modules that are built for accelerating the drug discovery process through AI/ML approach. Specifically, I collaborated with product managers, data engineering and data science team members in an agile environment. Besides, data curation part, I was also responsible for giving insights on improving the performance of LLMs via optimizing the prompts and evaluating the accuracy. 
