...
<style>
  ...
  .ci-email    { background: #dbeafe; }
  .ci-linkedin { background: #dbeafe; }
  .ci-github   { background: var(--surface-2); }
  .ci-scholar  { background: #dcfce7; }
  .contact-lbl {
    font-size: 0.7rem;
    color: var(--ink-light);
    font-weight: 500;
...
<div class="sdb-home">
  ...
  <div class="contact">
    ...
    <div class="contact-grid">
      <a class="contact-card" href="mailto:santoshdbhosale@gmail.com">
        <div class="contact-icon ci-email">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#1d4ed8" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="M2 7l10 7 10-7"/></svg>
        </div>
        <div>
          <p class="contact-lbl">Email</p>
          <p class="contact-val">santoshdbhosale@gmail.com</p>
        </div>
      </a>
      <a class="contact-card" href="https://www.linkedin.com/in/santoshdbhosale" target="_blank" rel="noopener">
        <div class="contact-icon ci-linkedin">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="#1d4ed8"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="4" r="2"/></svg>
        </div>
        <div>
          <p class="contact-lbl">LinkedIn</p>
          <p class="contact-val">santoshdbhosale</p>
        </div>
      </a>
      <a class="contact-card" href="https://github.com/santoshdbhosale" target="_blank" rel="noopener">
        <div class="contact-icon ci-github">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#4a4a6a" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"/></svg>
        </div>
        <div>
          <p class="contact-lbl">GitHub</p>
          <p class="contact-val">santoshdbhosale</p>
        </div>
      </a>
      <a class="contact-card" href="https://scholar.google.com/citations?user=sIxWbx0AAAAJ&hl=en" target="_blank" rel="noopener">
        <div class="contact-icon ci-scholar">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#15803d" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M22 10v6M2 10l10-5 10 5-10 5z"/><path d="M6 12v5c3 3 9 3 12 0v-5"/></svg>
        </div>
        <div>
          <p class="contact-lbl">Google Scholar</p>
          <p class="contact-val">View publications</p>
        </div>
      </a>
    </div>
    <div class="contact-status">
      <div class="status-dot"></div>
      <span><strong>Open to collaborations</strong> in proteomics, AI/ML drug discovery, and product leadership.</span>
    </div>
  </div>
