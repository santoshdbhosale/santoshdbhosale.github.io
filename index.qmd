...
<style>
  ...
  .logo-persistent { height: 26px; max-width: 160px; }
...
<div class="sdb-home">
  ...
  <div class="hero">
    ...
    <div>
      ...
      <p class="hero-role">Proteomics Scientist &nbsp;·&nbsp; AI/ML Drug Discovery &nbsp;·&nbsp; Scientific Project Leadership</p>
      <p class="hero-bio">
        A <strong>pharmacist-turned-proteomics scientist</strong> with a PhD and 15+ years spanning wet-lab mass spectrometry, computational proteomics, and AI/ML for drug discovery. Bridging deep domain biology with scalable data pipelines, client-facing insight generation, and project leadership.
      </p>
      <div class="hero-ctas">
  ...
  <div class="currently">
    <div class="c-dot"></div>
    <div>
      <strong>Currently:</strong> Domain Expert – Scientific Project Lead at <strong>Persistent Systems, Pune</strong> — bringing scientific and clinical domain expertise to patient-data driven healthcare analytics engagements. Focused on client communication, requirements translation, and insight generation (non-technical, domain-facing role), alongside scientific project leadership, mentorship, and training of project teams.
    </div>
  </div>
  ...
  <div class="expertise">
    ...
    <div class="expertise-grid">
      ...
      <div class="exp-card">
        <span class="exp-icon">🧭</span>
        <div class="exp-title">Scientific Project Leadership</div>
        <div class="exp-desc">Domain expertise on patient-data healthcare analytics engagements — client communication, requirements definition, and insight generation, plus scientific project management, mentorship, and training of teams.</div>
        <div class="exp-tags">
          <span class="exp-tag">Client Communication</span>
          <span class="exp-tag">Requirements</span>
    ...
    <table class="career-table">
      ...
      <tbody>
        <tr class="current-row">
          <td class="year-cell">2026–present</td>
          <td class="role-cell">Domain Expert – Scientific Project Lead</td>
          <td><div class="org-cell"><img src="img/persistent.png" alt="Persistent Systems" class="org-logo logo-persistent" /></div></td>
          <td>Pune, India</td>
        </tr>
        <tr>
          <td class="year-cell">2025–2026</td>
  ...
  <div class="publications">
    ...
    <div class="pub-list">
      <div class="pub-card">
        ...
        <div>
          <div class="pub-title">Idiopathic Intracranial Hypertension Is Characterized by a Distinct Proteomic Profile</div>
          <div class="pub-authors">Bhosale SD, Nawrocki A, et al. · Ann Neurol</div>
        </div>
      ...
      <div class="pub-card">
        <div class="pub-year">2026</div>
        <div>
          <div class="pub-title">Modeling Synaptic Maturation From Growth Cone to Synapse in Human Organoids</div>
          <div class="pub-authors">Øhlenschlæger MS, Bhosale S, et al. · J Neurochem</div>
        </div>
    ...
    <a href="cv/index.html" class="view-all">View all 24 publications and patent →</a>
  </div>

  <!-- ── INTERACTIVE HEATMAPS ── -->
  <div class="heatmaps">
    <p class="sec-label">Data Visualizations</p>
    <h2 class="sec-title">Interactive Proteomics Heatmaps</h2>
    <div class="heatmap-grid">
      <div class="heatmap-card">
        <div class="heatmap-icon">🧫</div>
        <div class="heatmap-topic">Organoids · Celiac Disease</div>
        <div class="heatmap-title">Mini-gut Organoid Proteomics</div>
        <div class="heatmap-desc">
          4,850 protein groups across crypt-like (ENRC) and differentiated enterocyte-like (ENRI) organoid states, cross-compared to human celiac disease biopsy markers. Companion data to <em>Front. Mol. Biosci.</em> 2024.
        </div>
        <div class="heatmap-links">
          <a href="https://santoshdbhosale.github.io/MG/20210309_MG.html" class="heatmap-btn heatmap-btn-primary" target="_blank">Explore Heatmap →</a>
          <a href="https://github.com/santoshdbhosale/MG" class="heatmap-btn heatmap-btn-secondary" target="_blank">GitHub</a>
        </div>
      </div>
      <div class="heatmap-card">
        <div class="heatmap-icon">🩸</div>
        <div class="heatmap-topic">ECFCs · COVID-19</div>
        <div class="heatmap-title">ECFC Proteomics — COVID-19 Severity</div>
        <div class="heatmap-desc">
          Proteomic changes in endothelial colony-forming cells exposed to serum from COVID-19 patients across four severity groups — asymptomatic to critically ill. Companion data to <em>Int J Biol Sci.</em> 2023.
        </div>
        <div class="heatmap-links">
          <a href="https://santoshdbhosale.github.io/ECFCs/20220202_ECFCs.html" class="heatmap-btn heatmap-btn-primary" target="_blank">Explore Heatmap →</a>
          <a href="https://github.com/santoshdbhosale/ECFCs" class="heatmap-btn heatmap-btn-secondary" target="_blank">GitHub</a>
        </div>
      </div>
    </div>
  </div>
